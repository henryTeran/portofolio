      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="mb-6">
              <span className="text-blue-400 font-medium text-lg">Bonjour, je suis</span>
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Spécialisé en <span className="text-blue-400 font-semibold">ERP</span>, 
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <button 
                ...
                className="bg-blue-500 hover:bg-blue-600 px-8 py-4 rounded-full font-semibold flex items-center justify-center gap-2 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
              ...
              <button 
                ...
                className="border-2 border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white px-8 py-4 rounded-full font-semibold transition-all duration-300"
              >
                Voir mes projets
              </button>
            </div>
            ...
            <div className="relative z-10 bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 shadow-2xl border border-slate-700">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="bg-gradient-to-br from-indigo-500/20 to-indigo-600/20 p-6 rounded-xl border border-indigo-500/30">
                  <div className="text-indigo-400 mb-4 text-2xl font-bold">AI</div>
