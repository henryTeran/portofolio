        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            <motion.div className="mb-6" variants={itemVariants}>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-display font-extrabold mt-2 mb-2" style={{color:'var(--text)'}}>Henry Teran</h1>
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold" style={{color:'var(--primary)'}}>{t('hero.role')}</h2>
            </motion.div>
            ...
            <motion.div className="flex flex-col sm:flex-row gap-4 mb-12 justify-center lg:justify-start" variants={itemVariants}>
            ...
            <motion.div className="grid grid-cols-3 gap-4 sm:gap-6 text-center" variants={itemVariants}>
              <div>
                <div className="text-2xl sm:text-3xl font-bold text-[var(--primary)]">6+</div>
                <div className="text-xs sm:text-sm text-[var(--muted)]">{t('hero.stats.projects')}</div>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl font-bold text-[var(--primary)]">5+</div>
                <div className="text-xs sm:text-sm text-[var(--muted)]">{t('hero.stats.technologies')}</div>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl font-bold text-green-400">24/7</div>
                <div className="text-xs sm:text-sm text-[var(--muted)]">{t('hero.stats.availability')}</div>
              </div>
            </motion.div>
          </motion.div>
